        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          ...
          <div class="lg:py-24 flex flex-col items-center lg:items-start relative z-10">
            <div class="flex items-center mb-8 relative">
              <div class="absolute -top-10 -left-10 w-24 h-24 bg-indigo-500/10 dark:bg-indigo-500/20 rounded-full blur-xl">
              </div>
              <img
                ...
                width="128"
                height="128"
                alt="Swann's Logo a S in a losange like node"
                style="animation: float 6s ease-in-out infinite"
              />
              <div class="flex flex-col">
                <h1 class="text-4xl lg:text-6xl font-bold bg-gradient-to-r from-indigo-500 to-purple-600 bg-clip-text text-transparent">
                  Swann Martin
                </h1>
            ...
            <p class="mt-4 text-gray-700 dark:text-gray-200 text-lg leading-relaxed text-center lg:text-left backdrop-blur-sm relative">
              <span class="absolute -left-4 top-0 w-1 h-full bg-indigo-500 opacity-70">
              </span>
              As a business, you need a platform that allows you to reach your
              audience. Swann Martin is the perfect solution for you. With Swann
              Martin, you can create a blog, portfolio, or personal website in
              minutes. Get started today and grow your audience.
            </p>

            <div class="mt-10 flex flex-wrap gap-4">
              <a
                href="https://swannmartin.xyz"
                class="inline-block rounded-full bg-indigo-600 px-10 py-4 text-base font-medium text-white transition-all duration-300 hover:bg-indigo-700 hover:shadow-lg hover:shadow-indigo-500/40 hover:-translate-y-1 focus:outline-none focus:ring focus:ring-indigo-400"
              >
                Get Started Today
              </a>
              <a
                href="#contact"
                class="inline-block rounded-full bg-white/10 backdrop-blur-sm dark:bg-gray-800/70 px-10 py-4 text-base font-medium text-indigo-600 dark:text-indigo-400 border border-indigo-600/60 dark:border-indigo-400/60 transition-all duration-300 hover:bg-indigo-50 dark:hover:bg-gray-700 hover:-translate-y-1 focus:outline-none focus:ring focus:ring-indigo-400"
              >
                Contact Me
              </a>
            </div>
